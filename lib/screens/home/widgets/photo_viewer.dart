...
import 'package:attendence_app/services/storage_service.dart';
      ...
      builder: (context, snapshot) {
        ...
        try {
          ...
          return Container(
            ...
            child: Center(
              child: Text(
                'Invalid image data', style: TextStyle(color: Colors.grey[600]),
              ),
            ),
          );
        }
      ...
      builder: (context) => Dialog(
        child: Column(
          ...
          children: [
            ...
            InteractiveViewer(
              child: Image.memory(bytes), // boar kalo di zoom in dan zoom out ttp itu2 aja fotonya
            )
          ],
        ),
      ),
